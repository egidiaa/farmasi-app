          ...
          <div class="row">
            <div class="col-lg-12 mx-auto align-self-center">
              <div class="site-block-cover-content text-center">
                ...
                <p><a href="/shop" class="btn btn-primary px-5 py-3">Belanja Sekarang Juga</a></p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row mb-5">
          <div class="col-md-12">
            <div class="bg-light rounded p-3">
              <p class="mb-0">Pelanggan Kembali ? <a href="#" class="d-inline-block">Klik di sini</a> Untuk Login</p>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 mb-5 mb-md-0">
            <h2 class="h3 mb-3 text-black">Rincian Tagihan</h2>
            <div class="p-3 p-lg-5 border">
              <div class="form-group">
                <label for="c_country" class="text-black">Negara <span class="text-danger">*</span></label>
                <select id="c_country" class="form-control">
                  <option value="1">Pilih salah satu Negara</option>
              ...
              <div class="form-group row">
                <div class="col-md-6">
                  <label for="c_state_country" class="text-black">negara asal <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" id="c_state_country" name="c_state_country">
                </div>
                <div class="col-md-6">
                  <label for="c_postal_zip" class="text-black">Pos / Arsip <span class="text-danger">*</span></label>
              ...
              <div class="form-group">
                <label for="c_create_account" class="text-black" data-toggle="collapse" href="#create_an_account"
                  role="button" aria-expanded="false" aria-controls="create_an_account"><input type="checkbox" value="1"
                    id="c_create_account"> Buat Akun ?</label>
                <div class="collapse" id="create_an_account">
                  <div class="py-2">
                    <p class="mb-3">Buat akun dengan memasukkan informasi di bawah ini. Jika Anda adalah pelanggan yang kembali
                      silahkan login di bagian atas halaman.</p>
                    <div class="form-group">
                      <label for="c_account_password" class="text-black">Password Akun</label>
              ...
              <div class="form-group">
                ...
                <div class="collapse" id="ship_different_address">
                  <div class="py-2">
                    ...
                    <div class="form-group row">
                      <div class="col-md-6">
                        <label for="c_diff_state_country" class="text-black">negara asal <span
                            class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="c_diff_state_country" name="c_diff_state_country">
                      </div>
                      <div class="col-md-6">
                        <label for="c_diff_postal_zip" class="text-black">Pos / Arsip <span
                            class="text-danger">*</span></label>
                    ...
                    <div class="form-group row mb-5">
                      ...
                      <div class="col-md-6">
                        <label for="c_diff_phone" class="text-black">Nomor Telepon <span class="text-danger">*</span></label>
            ...
            <div class="row mb-5">
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <label for="c_code" class="text-black mb-3">Masukkan Kode Kupon yang Anda miliki.</label>
                  <div class="input-group w-75">
                    <input type="text" class="form-control" id="c_code" placeholder="Coupon Code" aria-label="Coupon Code"
                      aria-describedby="button-addon2">
                    <div class="input-group-append">
                      <button class="btn btn-primary btn-sm px-4" type="button" id="button-addon2">Gunakan</button>
                    </div>
                  </div>
                ...
                <div class="p-3 p-lg-5 border">
                  <table class="table site-block-order-table mb-5">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="text-black font-weight-bold"><strong> Subtotal Belanja </strong></td>
                  ...
                  <div class="border mb-3">
                    ...
                    <div class="collapse" id="collapsebank">
                      <div class="py-2 px-4">
                        <p class="mb-0">Lakukan pembayaran langsung ke rekening bank kami. Silakan gunakan ID Pesanan Anda sebagai
                          referensi pembayaran Pesanan Anda tidak akan dikirim sampai dana dicairkan di rekening kami.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="border mb-3">
                    <h3 class="h6 mb-0"><a class="d-block" data-toggle="collapse" href="#collapsecheque" role="button"
                        aria-expanded="false" aria-controls="collapsecheque">Cek pembayaran</a></h3>
                  ...
                  <div class="form-group">
                      <button class="btn btn-primary btn-lg btn-block" onclick="window.location='thankyou.html'">Tolong Pesan</button>
                  </div>
