...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Daftar Obat" href="/daftar-obat"><span class="mini-sub-pro">Daftar Obat</span></a></li>
                                <li><a title="Edit Obat" href="/edit-obat"><span class="mini-sub-pro">Edit Obat</span></a></li>
                                <li><a title="Detail Obat" href="/detail-obat"><span class="mini-sub-pro">Detail Obat</span></a></li>
                                <li><a title="Keranjang Obat" href="/keranjang-obat"><span class="mini-sub-pro">Keranjang Obat</span></a></li>
                                <li><a title="Transaksi" href="/transaksi-obat"><span class="mini-sub-pro">Transaksi Obat</span></a></li>
                            </ul>
                        </li>
                        <li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="/index-admin"><img class="main-logo" src="asset/img/logo/logo.png" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                                                        ...
                                                                        <ul class="notes-menu-list">
                                                                            ...
                                                                            <li>
                                                                                <a href="#">
                                                                                    <div class="notes-list-flow">
                                                                                        <div class="notes-img">
                                                                                            <img src="asset/mg/contact/3.jpg" alt="" />
                                                                                        </div>
                                                                                        <div class="notes-content">
                                                                                            <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                            <span>Yesterday 2:45 pm</span>
	...
	<!-- float JS
		============================================ -->
    <script src="js/js/flot/jquery.flot.js"></script>
    <script src="js/js/flot/jquery.flot.resize.js"></script>
    <script src="js/js/flot/curvedLines.js"></script>
    <script src="js/js/flot/flot-active.js"></script>
    <!-- plugins JS
		============================================ -->
