...
<head>
	...
	<!-- nalika Icon CSS
		============================================ -->
    <link rel="stylesheet" href="css/css/nalika-icon.css">
    <!-- owl.carousel CSS
		============================================ -->
...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="/index-admin"><img class="main-logo" src="asset/logo.png" alt="" /></a>
                <h2>NE <span class="min-dtn">Pharmacy</span></h2>
            </div>
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a href="#"><img src="asset/nad.jpg" alt="" /></a>
					<h2>Akmal <span class="min-dtn">Nadya</span></h2>
				</div>
			</div>
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="/index-admin">
								   <i class="icon nalika-home icon-wrap"></i>
								   <span class="mini-click-non">Dashboard</span>
								</a>
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Obat" href="/index-admin"><span class="mini-sub-pro">Obat</span></a></li>
                                <li><a title="Daftar Obat" href="/admin/daftar-obat"><span class="mini-sub-pro">Daftar Obat</span></a></li>
                                <li><a title="Edit Obat" href="/admin/edit-obat"><span class="mini-sub-pro">Edit Obat</span></a></li>
                                <li><a title="Detail Obat" href="/admin/detail-obat"><span class="mini-sub-pro">Detail Obat</span></a></li>
                                <li><a title="Keranjang Obat" href="/admin/keranjang-obat"><span class="mini-sub-pro">Keranjang Obat</span></a></li>
                                <li><a title="Transaksi" href="/admin/transaksi-obat"><span class="mini-sub-pro">Transaksi Obat</span></a></li>
                            </ul>
                        </li>
                        <li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="/edit-obat">Edit Obat</a></li>
                                                <li><a href="/detail-obat">Detail Obat</a></li>
                                                <li><a href="/keranjang-obat">Keranjang Obat</a></li>
                                                <li><a href="/transaksi-obat">Transaksi Obat</a></li>
                                            </ul>
                                        </li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>Edit Obat</h2>
												<p>Selamat Datang di NE Pharmacy <span class="bread-ntd"></span></p>
											</div>
										</div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="/edit-produk"><i class="icon nalika-edit" aria-hidden="true"></i> Edit Produk</a></li>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="pro-edt-img">
                                                                <img src="asset/img/new-product/5-small.jpg" alt="" />
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="pro-edt-img">
                                                                <img src="asset/img/new-product/6-small.jpg" alt="" />
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="pro-edt-img mg-b-0">
                                                                <img src="asset/img/new-product/7-small.jpg" alt="" />
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <div class="row">
    ...
    <!-- morrisjs JS
		============================================ -->
    <script src="js/js/sparkline/jquery.sparkline.min.js"></script>
    <script src="js/js/sparkline/jquery.charts-sparkline.js"></script>
    <!-- calendar JS
		============================================ -->
    <script src="js/js/calendar/moment.min.js"></script>
    <script src="js/js/calendar/fullcalendar.min.js"></script>
    <script src="js/js/calendar/fullcalendar-active.js"></script>
    <!-- tab JS
		============================================ -->
