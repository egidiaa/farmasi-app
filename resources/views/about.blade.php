    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <span class="text-white">Solusi cepat, mudah ,dan hemat</span>
          <h1 class="text-capitalize mb-5 text-lg">NE PHARMACY SOLUSINYA!</h1>
...
<section class="section about-page">
	<div class="container">
		<div class="row">
			<div class="col-lg-4">
				<h2 class="title-color">Solusi Pembelian obat Masa Kini, NE PHARMACY siap membantu mu.</h2>
			</div>
			<div class="col-lg-8">
				<p>Sangat penting bagi Pasien untuk mengetahui obat apa yang cocok untuk gejala-gejala yang dirasakan. Oleh karena itu, NE PHARMACY menyediakan Layanan Konsultasi untuk Pasien yang memiliki gejala-gejala penyakit. Selain itu, akan banyak promo diskon yang akan anda dapatkan di NE PHARMACY.</p>
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					...
					<h4 class="mt-3">Layanan Konsultasi</h4>
					<p>Anda dapat mengkonsultasikan gejala-gejala yang Anda rasakan sekarang juga bersama kami.</p>
				</div>
			</div>
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					<img src="images/about/about-2.jpg" alt="" class="img-fluid w-100">
					<h4 class="mt-3">Promo dan Diskon</h4>
					<p>Dapatkan Promo menarik dan Diskon terbaik sekarang juga.</p>
				</div>
			</div>
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					<img src="images/about/about-3.jpg" alt="" class="img-fluid w-100">
					<h4 class="mt-3">Belanja Vitamin dan Obat</h4>
					<p>Temukan Obat yang Anda butuhkan dengan cepat dan mudah.</p>
				</div>
			</div>
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item">
					...
					<p>Kami siap melayani Kebutuhan Anda, Chat sekarang juga!</p>
				</div>
			</div>
		</div>
	</div>
